...
const SidebarJeunesse: React.FC = () => {
  ...
  const navItems: NavItem[] = [
    {
      ...
      path: '/bibliothecaire/chef/dashboard'
    },
    {
      name: 'Acquisitions',
      icon: GraduationCap,
      ...
      hasSubmenu: true,
      subItems: [
        { name: 'Session active', icon: Search, path: '/bibliothecaire/chef/session-active' },
        { name: 'Session d\'acquisitions', icon: BookPlus, path: '/bibliothecaire/chef/sesion-lists' }
      ]
    },
    {
      name: 'Administration',
      ...
      hasSubmenu: true,
      subItems: [
        { name: 'Politique d\'emprunt', icon: BookUp, path: '/bibliothecaire/chef/politique-emprunt' },
        { name: 'Type d\'adhésion', icon: RotateCcw, path: '/bibliothecaire/chef/adhesion' },
      ]
    }, {
      name: 'Exemplaires',
      icon: ShieldCheck,
      path: '/bibliothecaire/chef/exemplaires',
    
    },
    {
      name: 'Logs',
      icon: ScrollText,
      path: '/bibliothecaire/chef/logs'
    },
    {
      name: 'Annonces',
      icon: Megaphone,
      path: '/bibliothecaire/chef/annonces'
    }
  ];
...
export default SidebarJeunesse;